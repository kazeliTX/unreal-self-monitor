...
public:
    ...
    /** Register all UMG commands into the central registry. */
...
private:
    ...
    TSharedPtr<FJsonObject> HandleUpdateTextBlockText(const TSharedPtr<FJsonObject>& Params);
