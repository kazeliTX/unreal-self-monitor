...
public:
     ...
     * @param BlueprintName  Short asset name (e.g. "MyBP")
     * @param AssetPath      Optional full package path (e.g. "/Game/Characters/MyBP").
     *                       When empty, defaults to "/Game/Blueprints/<BlueprintName>".
     */
